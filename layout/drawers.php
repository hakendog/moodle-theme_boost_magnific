...
if (optional_param("embed-frame-top", 0, PARAM_INT)) {
    echo $OUTPUT->render_from_template("theme_boost_magnific/drawers_embed", $templatecontext);
} else {
    ...
    if (strpos($requesturi, "course/view.php") !== false || strpos($requesturi, "course/section.php") !== false) {
        ...
        if (strpos($requesturi, "course/view.php") !== false) {
            $templatecontext["course_summary_banner"] = get_config("theme_boost_magnific", "course_summary_banner");
    ...
    if ($courseindex || $hasblocks) {
        $templatecontext += theme_boost_magnific_progress_content();
    }
    ...
    echo $OUTPUT->render_from_template("theme_boost_magnific/drawers", $templatecontext);
}
